...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     */
    @Deprecated
    protected List<BasicNameValuePair> getPostParams() throws AuthFailureError {
        return getParams();
    }
     ...
     */
    private byte[] encodeParameters(List<BasicNameValuePair> params, String paramsEncoding) {
        StringBuilder encodedParams = new StringBuilder();
        try {
            for (BasicNameValuePair param : params) {

                encodedParams.append(URLEncoder.encode(param.getName(), paramsEncoding));
                encodedParams.append('=');
                encodedParams.append(URLEncoder.encode(param.getValue(), paramsEncoding));
                encodedParams.append('&');
            }
